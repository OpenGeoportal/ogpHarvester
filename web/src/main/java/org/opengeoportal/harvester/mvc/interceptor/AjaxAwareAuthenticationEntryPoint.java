...
public class AjaxAwareAuthenticationEntryPoint
     ...
     * @see LoginUrlAuthenticationEntryPoint#LoginUrlAuthenticationEntryPoint(java.lang.String)
     */
    ...
    public void commence(final HttpServletRequest request,
        ...
        AjaxAwareAuthenticationEntryPoint.LOG.debug("commence");
        if ("ajax".equals(request.getHeader("X-ats-type"))) {
            AjaxAwareAuthenticationEntryPoint.LOG
                    .debug("AJAX request detected - sending error code.");
            response.sendError(440, "Session Timeout");
        } else {
            AjaxAwareAuthenticationEntryPoint.LOG
                    .debug("Delegating processing to parent class");
