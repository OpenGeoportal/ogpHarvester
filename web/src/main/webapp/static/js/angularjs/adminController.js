(function() {
	...
	.controller('AdminCtrl', ['$scope', 'remoteRepositories', 'predefinedRepositories', 'defaultWorkspaces',
		'$modal', '$log', '$translate',

		function AdminCtrl($scope, remoteRepositories, predefinedRepositories, defaultWorkspaces, $modal, $log, $translate) {
		...
		$scope.addWorkspace = function() {
			...
			defaultWorkspaces.save($scope.newworkspacename).then(function(response) {
		...
		$scope.removeWorkspace = function(id) {
			...
			defaultWorkspaces.remove(id).then(function(response) {
