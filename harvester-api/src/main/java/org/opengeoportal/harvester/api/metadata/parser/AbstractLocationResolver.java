...
public abstract class AbstractLocationResolver implements LocationResolver {
	 ...
	 * 17076013_01_001a_s.sid%27&styles=&bbox=0.0,-65536.0,65536.0,0.0&width=512&height=512&srs=EPSG:404000&format=application/openlayers
	 * 
	...
	public Boolean isWMS(String link) {
		boolean result = link.toLowerCase().contains("wms");
		return result;
	}
	...
	public Boolean isWFS(String link) {
		boolean result = link.toLowerCase().contains("wfs");
		return result;
	...
	public Boolean isWCS(String link) {
		boolean result = link.toLowerCase().contains("wcs");
		return result;
	}
	...
	public Boolean isArcGISRest(String link) {
		boolean result = link.toLowerCase().contains("arcgis/rest");
		return result;
	 ...
	 */
	@Override
	public abstract Multimap<LocationType, LocationLink> resolveLocation(Document xmlDocument);
