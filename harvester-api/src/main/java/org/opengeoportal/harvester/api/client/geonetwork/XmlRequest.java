...
/**
 * Utility class used in {@link GeoNetworkClient} to send requests to the GeoNetwork server.
 *
...
{
    private static final Namespace NAMESPACE_ENV = Namespace.getNamespace("env", "http://www.w3.org/2003/05/soap-envelope");
